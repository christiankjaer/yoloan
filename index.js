...
(function($PS) {
  ...
  var heroBackground = Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Background.backgroundImage(CSS_Background.url("assets/shane-medium.jpg")))(function () {
  ...
  var hero = Halogen_HTML_Elements.section([ Halogen_HTML_Properties.classes([ "hero", "is-medium", "is-bold" ]), heroBackground ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("hero-body") ])([ Halogen_HTML_Elements.h1([ Halogen_HTML_Properties.class_("title") ])([ Halogen_HTML_Core.text("yoloan") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.class_("subtitle") ])([ Halogen_HTML_Core.text("gratis penge") ]) ]) ]);
  var footer = Halogen_HTML_Elements.footer([ Halogen_HTML_Properties.class_("footer") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "content", "has-text-centered" ]) ])([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.strong_([ Halogen_HTML_Core.text("yoloan") ]), Halogen_HTML_Core.text(" | "), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("mailto:preben@yoloan.dk") ])([ Halogen_HTML_Core.text("preben@yoloan.dk") ]) ]) ]) ]);
  var page = function (content) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container") ])([ hero, content, footer ]);
  };
  var sliderComponent = (function () {
      var render = function (state) {
          return page(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ "box" ]) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.classes([ "slider", "is-fullwidth", "is-large" ]), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropInputType)(DOM_HTML_Indexed_InputType.InputRange.value), Halogen_HTML_Properties.min(1000.0), Halogen_HTML_Properties.max(100000.0), Halogen_HTML_Properties.step(new DOM_HTML_Indexed_StepValue.Step(1000.0)), Halogen_HTML_Properties.value(Data_Show.show(Data_Show.showNumber)(state)), Halogen_HTML_Events.onValueChange(function (value) {
              return Data_Functor.map(Data_Maybe.functorMaybe)(SliderMoved.create)(Data_Number.fromString(value));
          }) ]), Halogen_HTML_Elements.span_([ Halogen_HTML_Core.text("L\xe5nebel\xf8b: " + (Data_Number_Format.toStringWith(Data_Number_Format.fixed(0))(state) + " kr.")) ]), Halogen_HTML_Elements.span([ Halogen_HTML_Properties.class_("is-pulled-right") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.classes([ "button", "is-primary" ]) ])([ Halogen_HTML_Core.text("Ans\xf8g!") ]) ]) ]));
      };
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(sliderComponent)(Data_Unit.unit)(body);
  }));
  exports["main"] = main;
  exports["page"] = page;
  exports["SliderMoved"] = SliderMoved;
